 ...
 * @author Willian
 */
public class JfrmCrudEstudiantes extends javax.swing.JFrame {

    /**
     * Creates new form JfrmCrudEstudiantes
     */
    public JfrmCrudEstudiantes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DETALLES DE ESTUDIANTE");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtIdEstudiante, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE))
    ...
    public String accionCrud = "Crear";
    public FrmEstudiantes frmEstudiantes = null;
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (accionCrud.equals("Crear")) {
            ...
            if (accionCrud.equals("Actualizar")) {
                ...
                CDEstudiantes clsD_Estudiantes = new CDEstudiantes();
                clsD_Estudiantes.ActualizarEstudiante(es);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmCrudEstudiantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmCrudEstudiantes().setVisible(true);
            }
        });
    }
